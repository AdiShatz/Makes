...
public class BookFactory {
    ...
    public CustomBook createNewBook(BookTemplate bookTemplate, String ownerName, Map<String,String>questionsMap,String chosenBookName,String templateBookCoverName)
    {
        ...
        CustomBook customBook = new CustomBook(chosenBookName,customPages,ownerName,templateBookCoverName);
        return customBook;
